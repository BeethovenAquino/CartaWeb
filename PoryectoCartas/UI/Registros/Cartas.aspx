<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="Cartas.aspx.cs" Inherits="PoryectoCartas.UI.Registros.Cartas" %>
                    ...
                    <div class="align-content-center">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<asp:Button ID="BuscarButton" runat="server" class="btn btn-info" Text="Buscar" OnClick="BuscarButton_Click" ValidationGroup="Buscar" />
                                         <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="CartaIDTextbox" ErrorMessage="Solo Numeros y Numeros positivos" ForeColor="Red" ValidationExpression="\d+" ValidationGroup="Buscar"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                            </table>
                        </div>
                         ...
                         <div>
                            <table>
                                <tr>
                                    <td>
                                        <strong>
                                            <asp:Label ID="Cuenta" runat="server" Text="DestinatarioID:"></asp:Label></strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <div>
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="CuerpoTextbox" runat="server" class="form-control" Height="30" Width="300" MaxLength="50"></asp:TextBox>
                                    </td>
                                    <td>
